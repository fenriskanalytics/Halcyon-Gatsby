...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: 21hHWiV01rOa/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg___8CGh)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__h1Iw1)}
              role={"img"}
            />
          ),
